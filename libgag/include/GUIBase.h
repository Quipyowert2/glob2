...
namespace GAGGUI
{
	...
	public:
		 ...
		 * This is a template method (a kind of skeleton), you
		 * can't override it. It call onTimer which should contain
		 ...
		 * If you find an event which is not handled by onSDLxxx
	...
	public:
		...
		//! Show or hide the widget, call show or hide depending on visible
